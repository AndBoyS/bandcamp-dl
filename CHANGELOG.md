...
- [Enhancement] ID3 Data Windows Explorer Compatibility. (Courtesy of [Bendito999](https://github.com/Bendito999))
...
- [Bugfix] Fixed [#62](https://github.com/iheanyi/bandcamp-dl/issues/62).
...
- [Bugfix] Fixed an encoding issue with accented characters in the filepath. (Thanks [oaubert](https://github.com/oaubert))
...
- [Bugfix] Monkey-patched Requests to fix compatibility with Python versions before 3.6.
